...
const questions = [
    ...
    },
    {
        ...
        "answers": [
            ...
            {
                "desc": "I'm somewhere between these two extremes.",
            ...
            <div class="modal-dialog modal-dialog-scrollable modal-lg">
                <div class="modal-content">
                    <div class="modal-header">
                        <h5 class="modal-title" id="conflictModalLabel">Are you sure?</h5>
                        <button type="button" class="btn-close" data-bs-dismiss="modal" aria-label="Close"></button>
                    </div>
                    <div class="modal-body">
                        <div class="alert alert-warning" role="alert">
                            Your choice conflicts with previous answers. If you want to keep it, you'll have to sacrifice the answers you're least confident in.
                        </div>

                        <div class="mb-4">
                            <h6 class="text-success mb-3"><i class="bi bi-plus-circle"></i> New Answer:</h6>
                        ...
                        <div class="mb-3">
                            <h6 class="mb-3"><i class="bi bi-list-check"></i> Your Previous Answers (uncheck to remove):</h6>
    `;
    ...
    modalHtml += `
                        ...
                        <div class="form-check">
                            ...
                            <label class="form-check-label" for="dontShowAgainCheckbox">
                                Don't show this dialog again (until reset)
                            </label>
                        </div>
                    </div>
                    <div class="modal-footer">
                        <button type="button" class="btn btn-secondary" id="conflictCancelBtn">Keep previous answers</button>
                        <button type="button" class="btn btn-primary" id="conflictConfirmBtn" disabled>Choose new answer</button>
                    </div>
                </div>
            </div>
        </div>
