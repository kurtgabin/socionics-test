...
const questions = [
    {
        ...
        answers: [
            ...
            { desc: "В фокусе моего внимания мир как он есть, без привязки к своему личному мнению.", subset: ["ЭСЭ", "ИЛЭ", "СЛЭ", "ЭИЭ", "ЛИЭ", "СЭЭ", "ИЭЭ", "ЛСЭ"] },
            { desc: "В фокусе моего внимания не просто что-то, а в первую очередь то, что это нечто значит лично для меня. ", subset: ["ЛИИ", "СЭИ", "ИЭИ", "ЛСИ", "ЭСИ", "ИЛИ", "СЛИ", "ЭИИ"] },
        ]
    },
    {
